...
{
  //fprintf(stderr, "char=%d(%c), Ctrl:%d, Shift:%d, Alt:%d\n", (int)c, (char)c, (int)(!!(mod & VTERM_MOD_CTRL)), (int)(!!(mod & VTERM_MOD_SHIFT)), (int)(!!(mod & VTERM_MOD_ALT)));
  ...
  //fprintf(stderr, needs_CSIu ? "    With CSIu\n" : "    No CSIu\n");
